...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        if (numericIndex === 0) {
            ...
            allNavItems[2].classList.add('active'); // 主标题
            allNavItems[3].classList.add('active'); // 子项(一)
        } else if (numericIndex === 3) {
            allNavItems[2].classList.add('active'); // 主标题
            allNavItems[4].classList.add('active'); // 子项(二)
        } else if (numericIndex === 4) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[6].classList.add('active'); // Section 4子项(一)
        } else if (numericIndex === 5) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[7].classList.add('active'); // Section 5子项(二)
        } else if (numericIndex === 6) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[8].classList.add('active'); // Section 6子项(三)
        } else if (numericIndex === 7) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[9].classList.add('active'); // Section 7子项(四)
        } else if (numericIndex === 8) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[10].classList.add('active'); // Section 8子项(五)
        } else if (numericIndex === 9) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[11].classList.add('active'); // Section 9子项(六)
        } else if (numericIndex === 10) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[12].classList.add('active'); // Section 10子项(七)
        } else if (numericIndex === 11) {
            allNavItems[5].classList.add('active'); // 主标题
            allNavItems[13].classList.add('active'); // Section 11子项(八)
        }
    }
...
function triggerPageAnimation(pageName) {
    ...
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                // 并行执行大标题和副标题动画
                typeWriter(h1, '6.自动书写、优化提示词的工作流', 100);
...
function downloadWorkflowFile() {
    const fileName = '案例一：自动优化提示词.json';
    const filePath = fileName; // 相对路径
