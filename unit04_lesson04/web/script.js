...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        if (numericIndex === 0) {
            ...
            activeMainNavIndex = 1; // 一、提示词模板与图片
        } else if (numericIndex >= 5) {
            activeMainNavIndex = 2; // 二、Sora2角色系统
        }
...
function triggerPageAnimation(pageName) {
    ...
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                // 并行执行大标题和副标题动画
                typeWriter(h1, '4. 从0-1带你制作一个AI视频', 100);
                typeWriter(subtitle, '掌握AI视频创作核心技能 | 提示词模板与角色系统实战', 50);
            }
        },
        'course': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '深入学习 AI视频创作的核心技术与实战方法', 50);
            }
        },
        'homework': () => {
            ...
            if (h1 && subtitle) {
                // 并行执行大标题和副标题动画
                typeWriter(h1, '📝 板块三：课后实战任务', 100);
                typeWriter(subtitle, '创建角色并使用CGML生成完整AI视频', 50);
            }
        }
    };
