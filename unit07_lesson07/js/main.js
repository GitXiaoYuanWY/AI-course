...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        // 导航项索引: 0=概览, 1=案例实战, 2=分析(主), 3-4=分析(子), 5=步骤(主), 6-9=步骤(子)
        if (numericIndex === 0) {
            ...
            allNavItems[3].classList.add('active'); // 子项
            ...
            allNavItems[6].classList.add('active'); // Section 4子项
        } else if (numericIndex === 5) {
            allNavItems[5].classList.add('active');
            allNavItems[7].classList.add('active'); // Section 5子项
        } else if (numericIndex === 6) {
            allNavItems[5].classList.add('active');
            allNavItems[8].classList.add('active'); // Section 6子项
        } else if (numericIndex === 7) {
            allNavItems[5].classList.add('active');
            allNavItems[9].classList.add('active'); // Section 7子项
        }
    }
...
function triggerPageAnimation(pageName) {
    ...
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                // 并行执行大标题和副标题动画
                typeWriter(h1, '7.帮你自动查资料！信息搜索工作流', 100);
