...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        if (index === 0) {
            ...
            activeMainNavIndex = 1; // 一、网页结构解析
        } else if (index >= 4 && index <= 8) {
            activeMainNavIndex = 2; // 二、资料整理
        } else if (index >= 9 && index <= 11) {
            activeMainNavIndex = 3; // 三、模块替换
        } else if (index >= 12 && index <= 14) {
            activeMainNavIndex = 4; // 四、实战操作
        } else if (index >= 15 && index <= 17) {
            activeMainNavIndex = 5; // 五、常见问题
        }
        ...
        const subNavMapping = {
            1: 0, 2: 0, 3: 1,  // 网页结构
            4: 2, 5: 3, 6: 4, 7: 5, 8: 6,  // 资料整理
            9: 7, 10: 8, 11: 8,  // 模块替换
            12: 9, 13: 10, 14: 10,  // 实战操作
            15: 11, 16: 12, 17: 13  // 常见问题
        };
...
function triggerPageAnimation(pageName) {
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                typeWriter(h1, '7.作品集网页内容整合与模块替换', 100);
                typeWriter(subtitle, '掌握个人作品集网页的内容填充与定制化技巧', 50);
            }
        },
        'course': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '深入学习作品集网页的内容整合技巧', 50);
            }
        },
        'homework': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '完成个人作品集网页的内容整合', 50);
            }
        }
    };
