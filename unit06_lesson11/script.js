...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        // 建立section索引到导航项索引的映射
        // section 0: hero (无导航项)
        // section 1: 一、替换文本内容 (导航项0)
        // section 2-3: 子章节 (无导航项)
        // section 4: 二、替换图片 (导航项1)
        // section 5: 子章节 (无导航项)
        // section 6: 三、项目卡片操作 (导航项2)
        // section 7: 四、AI辅助修改 (导航项3)
        // section 8: 五、CSS结构 (导航项4)
        // section 9: 六、调整风格 (导航项5)
        // section 10: 七、错误排查 (导航项6)
        // section 11: 八、GitHub部署 (导航项7)
        const sectionToNavMap = {
            0: -1,  // hero, 无对应导航
            1: 0,   // 一、替换文本内容
            2: 0,   // About模块示例，属于第一章
            3: 0,   // Skills模块示例，属于第一章
            4: 1,   // 二、替换图片
            5: 1,   // 更换头像示例，属于第二章
            6: 2,   // 三、项目卡片操作
            7: 3,   // 四、AI辅助修改
...
function triggerPageAnimation(pageName) {
    ...
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                typeWriter(h1, '11.AI 作品集网页实战（下）', 80);
                typeWriter(subtitle, '内容个性化与排错部署 | 从模板到个人作品', 40);
            }
        },
        'course': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '从模板到个人作品的完整流程', 50);
            }
        },
        'homework': () => {
            ...
            if (h1 && subtitle) {
                // 直接显示标题，避免emoji在打字机动画中出现问题
                h1.textContent = '📝 课后作业';
                h1.style.opacity = '1';
                typeWriter(subtitle, '动手实践，巩固所学知识', 50);
            }
        }
    };
