...
class SectionScroller {
    ...
    updateNavigation(index) {
        ...
        if (index === 0) {
            ...
            activeMainNavIndex = 1; // 一、我要做什么歌
        } else if (index >= 5 && index <= 9) {
            activeMainNavIndex = 2; // 二、写歌词和风格
        } else if (index >= 10 && index <= 11) {
            activeMainNavIndex = 3; // 三、在Suno里怎么填
        } else if (index >= 12) {
            activeMainNavIndex = 4; // 四、生成结果鉴赏
        }
...
function triggerPageAnimation(pageName) {
    const animationMap = {
        'overview': () => {
            ...
            if (h1 && subtitle) {
                typeWriter(h1, '6. 从0-1带你制作一个AI音乐', 100);
                typeWriter(subtitle, 'Suno AI音乐创作完整教程 | 从创意到成品', 50);
            }
        },
        'course': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '深入学习 AI 音乐创作的完整流程', 50);
            }
        },
        'homework': () => {
            ...
            if (h1 && subtitle) {
                ...
                typeWriter(subtitle, '巩固AI音乐创作实操流程', 50);
            }
        }
    };
